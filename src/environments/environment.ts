// Orsettocommerce Multi Vendor marketplace v5
...
export const environment = {
  ...
  logo: 'assets/imgs/orsettov5-logo-new.svg', // Your logo to appear in sign-in screen. Replace your own file with the same name in the folder path /assets/imgs/
